...
async def approve(_, m : Message):
    ...
    try:
        ...
        await app.send_video(kk.id,img, "**Hello {}!\nWelcome To {}\n\n__Powerd By : @vijaysahu_2 __**".format(m.from_user.mention, m.chat.title))
        add_user(kk.id)
    ...
    try:
        ...
        if m.chat.type == enums.ChatType.PRIVATE:
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("🗯 Channel", url="@vijaysahu_2"),
                        InlineKeyboardButton("💬 Support", url="https://t.me/vijaysahu_2")
                    ],[
            ...
            await m.reply_photo("https://te.legra.ph/file/eecf9619a8d09dcc59bf4.jpg", caption="**🦊 Hello {}!\nI'm an auto approve [Admin Join Requests]({}) Bot.\nI can approve users in Groups/Channels.Add me to your chat and promote me to admin with add members permission.\n\n__Powerd By : @vijaysahu_2 __**".format(m.from_user.mention, "https://t.me/telegram/153"), reply_markup=keyboard)
...
async def chk(_, cb : CallbackQuery):
    try:
        ...
        if cb.message.chat.type == enums.ChatType.PRIVATE:
            ...
            await cb.message.edit("**🦊 Hello {}!\nI'm an auto approve [Admin Join Requests]({}) Bot.\nI can approve users in Groups/Channels.Add me to your chat and promote me to admin with add members permission.\n\n__Powerd By : @vijaysahu_2 __**".format(cb.from_user.mention, "https://t.me/telegram/153"), reply_markup=keyboard, disable_web_page_preview=True)
